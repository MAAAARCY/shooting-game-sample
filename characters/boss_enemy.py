...
class BossEnemy(pygame.sprite.Sprite):
    def __init__(self):
        super().__init__()
        self._boss_enemy_img = pygame.image.load("images/{}".format(os.getenv('ENEMY_IMAGE')))
        self._x = ENEMY_X
        self._y = ENEMY_Y
        self.image = pygame.transform.scale(self._boss_enemy_img, (ENEMY_WIDTH, ENEMY_HEIGHT))
